      ...
      <div className="bg-white backdrop-blur-lg p-8 rounded-2xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        {authMethod === null ? (
          <div className="space-y-4">
            <button
              ...
              className="w-full py-3 px-4 bg-[#0052CC] hover:bg-[#003D99] text-white rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
              disabled={loading}
            >
              <svg
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-[#0052CC] hover:bg-[#003D99] text-white rounded-xl font-medium transition-colors disabled:opacity-70 flex items-center justify-center gap-2"
              disabled={loading}
            >
              {loading ? (
                <>
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            Start your journey with <b className="text-gray-800">DriveLaw</b> —
            the smarter, faster way to manage your{" "}
            <span className="text-blue-600 font-semibold">
              traffic violations and fines
            </span>
            . Create an account or log in and{" "}
            <i>resolve violations efficiently</i>.
          </p>
        </div>
      </div>
    </div>
