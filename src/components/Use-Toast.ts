...
const TOAST_REMOVE_DELAY = 5000 // 5 seconds (more reasonable than 1000000)

type ToastProps = React.ComponentPropsWithoutRef<typeof Toast> & VariantProps<typeof Toast>
...
// Enhanced helper functions for different toast types
...
// Enhanced useToast hook with helper methods
function useToast() {
